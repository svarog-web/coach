<?php
/**
* Community Builder (TM) cbgallery Portuguese (Brazil) language file Frontend
* @version $Id:$
...
'FILE_SHOULD_EXCEED_SIZE'	=>	'O arquivo deve ser maior que [size]',
'FILE_SHOUND_NOT_EXCEED_SIZE'	=>	'Seu arquivo não deve ser maior que [size]',
...
'PENDING_APPROVAL_017e8b'	=>	'Aprovação pendente',

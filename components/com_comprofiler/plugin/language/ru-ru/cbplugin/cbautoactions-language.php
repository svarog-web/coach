...
'CLICK_TO_EXECUTE_ddbd31'	=>	'Щелкните для запуска',
'AUTO_ACTION_ACCESS_FAILED'	=>	':: Действие \'[action]\' :: Проверка прав доступа пользователя \'[user_id]\' не удалась: ищется уровень доступа \'[access]\' в группах \'[groups]\'',
'AUTO_ACTION_CONDITIONAL_FAILED'	=>	':: Действие \'[action]\' :: Условие \'[cond]\' сорвалось для пользователя \'[user_id]\': поле \'[field]\' - оператор \'[operator]\' - значение [value]',

<?php
/**
* Community Builder (TM) cbgroupjivewall Japanese (Japan) language file Administration
* @version $Id:$
...
'OPTIONALLY_ENABLE_OR_DISABLE_USAGE_OF_WALL_POSTS_G_ae9a1a'	=>	'必要に応じて、ウォール投稿の使用を有効または無効にします。グループの所有者とグループ管理者は、この設定を免除され、常にウォールへ投稿することができます。既存のウォール投稿には、まだアクセスできる事に注意してください。',

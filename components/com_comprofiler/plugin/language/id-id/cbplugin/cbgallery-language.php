<?php
/**
* Community Builder (TM) cbgallery Indonesian (Indonesia) language file Frontend
* @version $Id:$
...
'FILE_SHOULD_EXCEED_SIZE'	=>	'File anga seharusnya [size]',
'FILE_SHOUND_NOT_EXCEED_SIZE'	=>	'File anda tidak sesuai ukuran [size]',

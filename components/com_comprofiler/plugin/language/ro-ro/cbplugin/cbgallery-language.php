<?php
/**
* Community Builder (TM) cbgallery Romanian (Romania) language file Frontend
* @version $Id:$
...
'FILE_SHOULD_EXCEED_SIZE'	=>	'Fisierul tau trebuie sa depaseasca [size].',
'FILE_SHOUND_NOT_EXCEED_SIZE'	=>	'Fisierul tau nu trebuie sa depaseasca [size].',

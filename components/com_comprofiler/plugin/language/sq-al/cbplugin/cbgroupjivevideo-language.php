<?php
/**
* Community Builder (TM) cbgroupjivevideo Albanian (Albania) language file Frontend
* @version $Id:$
...
'INPUT_PAGE_LIMIT_PAGE_LIMIT_DETERMINES_HOW_MANY_RO_61ece3'	=>	'Limite nga faqja, këto limite për faqe mundësojn apo parandalojnë numrin e rradhëve për shfaqje',

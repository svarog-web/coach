<?php
/**
* Community Builder (TM) cbgallery Albanian (Albania) language file Frontend
* @version $Id:$
...
'INPUT_OWNER_AS_SINGLE_INTEGER_USERID_169965'	=>	'Hyrja për pronar si numër i plot uder_id',

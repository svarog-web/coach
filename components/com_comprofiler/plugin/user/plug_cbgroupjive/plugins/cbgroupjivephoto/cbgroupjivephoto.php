...
$_PLUGINS->registerFunction( 'activity_onQueryActivity', 'activityQuery', '\CB\Plugin\GroupJivePhoto\Trigger\ActivityTrigger' );
$_PLUGINS->registerFunction( 'activity_onBeforeDisplayActivity', 'activityPrefetch', '\CB\Plugin\GroupJivePhoto\Trigger\ActivityTrigger' );
$_PLUGINS->registerFunction( 'activity_onDisplayActivity', 'activityDisplay', '\CB\Plugin\GroupJivePhoto\Trigger\ActivityTrigger' );
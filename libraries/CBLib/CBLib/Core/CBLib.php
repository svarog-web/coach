...
class CBLib
{
	protected static $THISCBVERSION		=	'2.1.2+build.2017.01.28.02.24.35.b65a69f75';	 	// IMPORTANT: DO NOT CHANGE MANUALLY, but when changing version automatically here also change in cbInstallerPlugin.php, the 8 XML installation files and build.xml and just above
	/**
	 * @var Application
	 */
